...
<div id="submission-notice-overlay" class="fixed inset-0 z-[120] flex items-center justify-center bg-[#004241]/25 px-4">
    <div class="w-full max-w-md rounded-[28px] border border-[#DED8CE] bg-[#F8F6F2] p-6 shadow-[0_24px_60px_rgba(0,66,65,0.18)]">
        <div class="flex items-start justify-between gap-4">
            <div class="flex items-start gap-3">
                <div class="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#004241] text-[#F8F6F2]">
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm leading-6 text-[#004241]/80"><?= htmlspecialchars($submissionNotice['message']) ?></p>
                </div>
            </div>
            <button type="button" id="submission-notice-close" class="flex h-9 w-9 items-center justify-center rounded-full text-[#004241]/70 transition hover:bg-[#EBF1EF] hover:text-[#004241]" aria-label="Fermer la confirmation">
                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div class="mt-6 flex justify-end">
            <button type="button" id="submission-notice-confirm" class="inline-flex h-11 items-center justify-center rounded-full bg-[#004241] px-6 text-sm font-semibold text-[#F8F6F2] transition hover:bg-[#003535]">
                Compris
            </button>
        </div>
    </div>
