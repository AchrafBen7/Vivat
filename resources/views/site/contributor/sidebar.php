...
<aside class="flex w-[260px] shrink-0 flex-col rounded-[24px] border border-[#004241]/10 bg-white shadow-[0_4px_20px_rgba(0,66,65,0.06)]">
    ...
    <div class="mt-auto border-t border-[#004241]/8 p-3 flex flex-col gap-1">
        ...
        <a href="#" class="flex items-center gap-3 rounded-[12px] h-10 px-4 text-[14px] font-medium text-[#AE422E]/90 hover:bg-[#AE422E]/5 hover:text-[#AE422E] transition-colors" title="<?= htmlspecialchars($t('site.coming_soon', 'Bientôt disponible')) ?>">
