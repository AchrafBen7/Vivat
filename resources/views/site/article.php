...
<div class="w-full max-w-[1400px] mx-auto">
    <!-- Bannière pub 728×90 -->
    <div class="flex items-center justify-center rounded-[30px] overflow-hidden mb-6" style="padding-right: 48px; padding-bottom: 48px; padding-left: 48px;">
        <div class="flex items-center justify-center text-[#686868] border-2 border-dashed border-[#686868]/40 rounded-[30px]" style="width: 100%; max-width: 728px; height: 90px; gap: 8px;">
    ...
    <div class="relative w-full mx-auto rounded-[30px] overflow-hidden mb-[54px]" style="max-width: 1282px; height: 444px; min-height: 280px; background: rgba(0,0,0,0.3);">
        ...
        <div class="absolute inset-0 flex flex-col" style="padding: 32px; top: 0; left: 0;">
            ...
            <h1 class="text-white font-semibold leading-[100%] max-w-[947px]" style="font-family: Figtree, sans-serif; font-size: 48px; margin-bottom: 9px;"><?= htmlspecialchars($title) ?></h1>
            <?php if ($metaLine): ?>
            <p class="text-white font-light leading-[100%]" style="font-family: Figtree, sans-serif; font-size: 20px; opacity: 0.95;">
...
<div class="w-full max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_auto] lg:gap-[130px]">
    ...
    <aside class="flex flex-col mt-12" aria-label="Partager l'article">
        <span class="font-normal leading-[100%] mb-6" style="font-family: Figtree, sans-serif; font-size: 20px; color: #004241;">Partager</span>
        <div class="flex flex-row" style="gap: 24px;">
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?= rawurlencode($shareUrl) ?>" target="_blank" rel="noopener noreferrer" class="text-[#004241] hover:opacity-80 transition" style="width: 22px; height: 22px;" aria-label="Partager sur Facebook">
                <svg class="w-[22px] h-[22px]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://twitter.com/intent/tweet?url=<?= rawurlencode($shareUrl) ?>&text=<?= rawurlencode($shareTitle) ?>" target="_blank" rel="noopener noreferrer" class="text-[#004241] hover:opacity-80 transition" style="width: 22px; height: 22px;" aria-label="Partager sur X">
            ...
            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" class="text-[#004241] hover:opacity-80 transition" style="width: 22px; height: 22px;" aria-label="Partager sur Instagram">
            ...
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?= rawurlencode($shareUrl) ?>" target="_blank" rel="noopener noreferrer" class="text-[#004241] hover:opacity-80 transition" style="width: 22px; height: 22px;" aria-label="Partager sur LinkedIn">
                <svg class="w-[22px] h-[22px]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            <a href="https://wa.me/?text=<?= rawurlencode($shareTitle . ' ' . $shareUrl) ?>" target="_blank" rel="noopener noreferrer" class="text-[#004241] hover:opacity-80 transition" style="width: 22px; height: 22px;" aria-label="Partager sur WhatsApp">
