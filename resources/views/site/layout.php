    ...
    <header id="site-header" class="relative z-50 isolate bg-gradient-to-b from-white from-0% via-white via-[40%] to-[#EBF1EF]/32 to-100% shadow-[0_6px_20px_-4px_rgba(0,66,65,0.075),0_14px_36px_-18px_rgba(0,66,65,0.05)]">
        <div class="max-w-[1400px] mx-auto px-[18px] md:px-8 lg:px-10 xl:px-20 relative z-50">
            ...
            <div id="mobile-menu-panel"
                ...
                <?php if (auth()->check()) { ?>
                <!-- Bloc utilisateur : carte + déconnexion groupées -->
                <div class="mb-7">
                ...
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-12">
                    ...
                    <nav aria-label="Navigation principale">
                        ...
                        <div class="flex flex-col gap-0.5">
                            ...
                            <!-- CTA Rédiger : visuellement distinct -->
                    ...
                    <div>
                        ...
                        <nav class="grid grid-cols-2 gap-x-1 gap-y-0.5 sm:grid-cols-3 lg:grid-cols-3" aria-label="<?= htmlspecialchars(__('site.sections')) ?>">
