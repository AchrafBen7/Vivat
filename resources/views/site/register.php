...
$t = $locale === 'nl'
    ? [
        ...
        'password_help' => 'Minimaal 8 tekens met een hoofdletter, een kleine letter, een cijfer en een symbool.',
    ...
    : [
        ...
        'password_help' => 'Minimum 8 caractères avec une majuscule, une minuscule, un chiffre et un symbole.',
        ...
        <div class="mx-auto flex w-full max-w-[34rem] flex-1 flex-col lg:max-w-[35rem] lg:justify-center">
            ...
            <div class="mt-7 flex flex-col items-center">
                ...
                <a
                    ...
                    class="mt-5 inline-flex h-11 w-full items-center justify-center gap-3 rounded-full border border-transparent bg-white text-sm font-medium text-[#004241] transition hover:bg-gray-50"
