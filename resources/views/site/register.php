...
<div class="pt-6 pb-12">
    <div class="flex flex-col lg:flex-row gap-6 lg:gap-8 items-stretch justify-center max-w-[1320px] mx-auto">
        ...
        <div class="relative w-full lg:w-[628px] flex-shrink-0 rounded-[30px] overflow-hidden" style="height: 850px; min-height: 400px;">
            ...
            <a href="/" class="absolute flex items-center justify-center gap-2.5 rounded-full text-[#004241] font-normal text-base leading-none bg-white hover:opacity-90 transition" style="top: 24px; left: 24px; width: 115px; height: 43px; padding: 12px 18px;">
