...
<div class="mx-auto flex w-full max-w-[1280px] flex-col" style="gap: 24px;">
    ...
    <section class="rounded-[30px] bg-white px-6 py-5" style="box-shadow: 0 18px 48px rgba(0, 66, 65, 0.08);">
        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <a href="/faq" class="inline-flex items-center justify-center rounded-full bg-[#EBF1EF] px-5 py-3 text-sm font-medium text-[#004241] no-underline transition hover:bg-[#e2ece8]">Voir la FAQ</a>
        </div>
    </section>
</div>
